	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i=0;i<trials;i++) {
				BasicDocument bd = new BasicDocument(test);
				double flesch = bd.getFleschScore();
			}
			long elapsedTime = System.nanoTime() - startTime;
			System.out.print((double)elapsedTime/1000000000.0+"\t");
			
			long startTime1 = System.nanoTime();
			for(int i=0;i<trials;i++) {
				EfficientDocument bd = new EfficientDocument(test);
				double flesch = bd.getFleschScore();
			}
			long elapsedTime1 = System.nanoTime() - startTime1;
			System.out.print((double)elapsedTime1/1000000000.0);
			System.out.println();
		}
